                ...
                <div class="panel panel-default">
                    <div class="panel-body backgSet">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Type</label>
                                    <input type="text" name="type" class="form-control" placeholder="Enter The Name">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Link To Open English</label>
                                    <input type="text" name="link_english" class="form-control" placeholder="">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Link To Open Arabic</label>
                                    <input type="text" name="link_arabic" class="form-control" placeholder="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-footer text-right" dir="ltr">
                            ...
                            <button type="Submit" class="btn btn-maden">Add System Page</button>
                        </div>
                    </div>
                </div>
            </div>
