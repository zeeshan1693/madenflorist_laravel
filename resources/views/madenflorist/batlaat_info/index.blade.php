...
<div class="container-fluid">
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-4">
                <h1 class="page-header">Batlaat Info</h1>
            </div>
            <div class="col-lg-4 offset-lg-4">
                <div class="text-right">
                    <a href="{{ route('batlaat-info.create') }}"><button type="button" class="btn btn-maden">Add New Line</button></a>
                </div>
            </div>
        </div>
                        ...
                        <table id="example" class="table table-hover" style="width:100%">
                            ...
                            <tbody>
                                <tr>
                                    <td>01</td>
                                    <td>Bold</td>
                                    <td>How Earn Petals?</td>
                                    <td>How Earn Petals?</td>
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group" aria-label="Small button group">
                                            <a href="{{ route('batlaat-info.edit',1) }}">
