...
<div class="container-fluid">
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-4">
                <h1 class="page-header">Add Template Email</h1>
            </div>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email_subject" class="form-control" placeholder="Enter the subject">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Email Body</label>
                                    <textarea rows="2" cols="2" class="form-control" name="text_body"></textarea>
                                </div>
                            </div>
                        </div>
