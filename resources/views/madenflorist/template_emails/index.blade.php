...
<div class="container-fluid">
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-4">
                <h1 class="page-header">Template Email</h1>
            </div>
            <div class="col-lg-4 offset-lg-4">
                <div class="text-right">
                    <a href="{{ route('template-emails.create') }}"><button type="button" class="btn btn-maden">Add Template Email</button></a>
                </div>
            </div>
        </div>
                        ...
                        <table id="example" class="table table-hover" style="width:100%">
                            ...
                            <tbody>
                                <tr>
                                    <td>01</td>
                                    <td>Paid</td>
                                    <td>Order id : $order_id PAID</td>
                                    <td>Your order of $order_id, amount $amount has been paid</td>
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group" aria-label="Small button group">
                                            <a href="{{ route('template-emails.edit',1) }}">
