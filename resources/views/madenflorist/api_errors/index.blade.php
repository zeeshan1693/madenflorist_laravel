...
<div class="container-fluid">
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-4">
                <h1 class="page-header">API Error</h1>
            </div>
            <div class="col-lg-4 offset-lg-4">
                <div class="text-right">
                    <a href="{{ route('api-errors.create') }}"><button type="button" class="btn btn-maden">Add API Error</button></a>
                </div>
            </div>
        </div>
                        ...
                        <table id="example" class="table table-hover" style="width:100%">
                            ...
                            <tbody>
                                <tr>
                                    <td>01</td>
                                    <td>200</td>
                                    <td>Accepted Succesfully</td>
                                    <td>Accepted Succesfully</td>
                                    <td>Accepted Succesfully</td>
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group" aria-label="Small button group">
                                            <a href="{{ route('api-errors.edit',1) }}">
