...
<div class="container-fluid">
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-4">
                <h1 class="page-header">Edit Wallet Amount</h1>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="english_name" class="form-control" placeholder="300 Riyal">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Arabic Name</label>
                                    <input type="text" name="arabic_name" class="form-control" placeholder="300 Riyal">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
