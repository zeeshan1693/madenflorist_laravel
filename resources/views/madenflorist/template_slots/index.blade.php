...
<div class="container-fluid">
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-4">
                <h1 class="page-header">Template Slots</h1>
            </div>
            <div class="col-lg-4 offset-lg-4">
                <div class="text-right">
                    <a href="{{ route('template-slots.create') }}"><button type="button" class="btn btn-maden">Add Template</button></a>
                </div>
            </div>
        </div>
                    ...
                    <div class="panel-body backgSet">
                        <table id="example" class="table table-hover" style="width:100%">
                            ...
                            <tbody>
                                <tr>
                                    <td>01</td>
                                    <td>Simple Time Slots</td>
                                    <td>Simple Time Slots</td>
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group" aria-label="Small button group">
                                            <a href="{{ route('template-slots.edit',1) }}">
