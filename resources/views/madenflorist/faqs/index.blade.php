        ...
        <div class="row">
            ...
            <div class="col-lg-4 offset-lg-4">
                <div class="text-right">
                    <a href="{{ route('faqs.create') }}"><button type="button" class="btn btn-maden">Add FAQs</button></a>
                </div>
            </div>
        </div>
                    ...
                    <div class="panel-body backgSet">
                        <table id="example" class="table table-hover" style="width:100%">
                            ...
                            <tbody>
                                <tr>
                                    <td>01</td>
                                    <td>What is Maden First?</td>
                                    <td>What is Maden First?</td>
                                    <td>1</td>
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group" aria-label="Small button group">
                                            <a href="{{ route('faqs.edit',1) }}">
                                ...
                                <tr>
                                    <td>01</td>
                                    <td>How can I pay with Maden Flkorist?</td>
                                    <td>How can I pay with Maden Flkorist?</td>
                                    <td>2</td>
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group" aria-label="Small button group">
