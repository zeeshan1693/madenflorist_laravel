...
<div class="container-fluid">
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-4">
                <h1 class="page-header">Edit Batlaat Points</h1>
            </div>
        </div>
                    ...
                    <div class="panel-body backgSet">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Points</label>
                                    <input type="text" name="points" class="form-control" placeholder="1">
                                </div>
                            </div>
                        </div>

                        <div class="card-footer text-right" dir="ltr">
                            <a href="{{ route('batlaat-programs.index') }}" class="btn btn btn-outline-dark">Cancel</a>
