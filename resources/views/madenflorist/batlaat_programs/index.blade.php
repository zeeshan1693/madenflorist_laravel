...
<div class="container-fluid">
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-4">
                <h1 class="page-header">Batlaat Program</h1>
            </div>
            <div class="col-lg-4 offset-lg-4">
                <div class="text-right">
                    <button type="button" class="btn custom-warning">Batlaat Redeem</button>
                    <a href="{{ route('batlaat-programs.create') }}"><button type="button" class="btn btn-maden">Batlaat Calculator</button></a>
                </div>
            </div>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group" aria-label="Small button group">
                                            <a href="{{ route('batlaat-programs.edit',1) }}">
