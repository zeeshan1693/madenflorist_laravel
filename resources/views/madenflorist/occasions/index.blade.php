...
<div class="container-fluid">
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-4">
                <h1 class="page-header">Occasions</h1>
            </div>
            <div class="col-lg-4 offset-lg-4">
                <div class="text-right">
                    <a href="{{ route('occasions.create') }}"><button type="button" class="btn btn-maden">Add Occasion</button></a>
                </div>
            </div>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="custom-control custom-switch">
                                            ...
                                            <label class="custom-control-label" for="customSwitches2">Banned</label>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group" aria-label="Small button group">
