...
<div class="container-fluid">
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-4">
                <h1 class="page-header">Account Deletion</h1>
            </div>
            <div class="col-lg-4 offset-lg-4">
                <div class="text-right">
                    <a href="{{ route('account-deletions.create') }}"><button type="button" class="btn btn-maden">Add Account Deletion Reason</button></a>
                </div>
            </div>
        </div>
                    ...
                    <div class="panel-body backgSet">
                        <table id="example" class="table table-hover" style="width:100%">
                            ...
                            <tbody>
                                <tr>
                                    <td>01</td>
                                    <td>I have a privacy concern</td>
                                    <td>I have a privacy concern</td>
                                    <td>1</td>
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group" aria-label="Small button group">
                                            <a href="{{ route('account-deletions.edit',1) }}">
                                ...
                                <tr>
                                    <td>01</td>
                                    <td>I am getting too many emails</td>
                                    <td>I am getting too many emails</td>
                                    <td>2</td>
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group" aria-label="Small button group">
